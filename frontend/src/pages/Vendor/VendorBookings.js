...
import { setBookings } from "../../redux/vendor/vendorBookingSlice";
import DashboardSidebar from "../../common/DashboardSidebar";
import DeleteBookingDialog from "../Admin/components/DeleteBookingDialog";
...
const VendorBookings = () => {
  ...
  const allBookings = useSelector((state) => state.vendorbookings.bookings);
    ...
    const fetchBookings = async () => {
      try {
        ...
        const response = await axios.get(
          "http://localhost:5600/bookings/vendorbookings",
          {
