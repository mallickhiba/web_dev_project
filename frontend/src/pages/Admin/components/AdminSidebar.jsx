...
const DashboardSidebar = ({ active }) => {
    ...
    const navItems = [
        { text: "Dashboard", icon: <DashboardOutlined sx={{color: `${active === 1 ? "crimson" : "#555"}` }} />, link: "/adminhome" },
      { text: "User Management", icon: <PeopleIcon sx={{color: `${active === 2 ? "crimson" : "#555"}` }} />, link: "/user-management" },
      { text: "Approve Vendors ", icon: <CheckCircleOutlineIcon sx={{color: `${active === 3 ? "crimson" : "#555"}` }}/>, link: "/approve-vendors" },
      {/* text: "Bookings", icon: null */ },
      { text: "Booking Management", icon: <CalendarMonth sx={{color: `${active === 4 ? "crimson" : "#555"}` }}/>, link: "/booking-management" },
      { text: "Review Management", icon: <ReviewsIcon sx={{color: `${active === 5 ? "crimson" : "#555"}` }} />, link: "/review-management" },
    ];
