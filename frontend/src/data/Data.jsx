  ...
  export const services = [
    {
      ...
      name: "Venues",
      discription: "Explore the best Venues.",
    },
    {
      icon: <i class="fa fa-utensils fa-2x text-primary"></i>,
      name: "Catering",
      discription: "Explore the finest food",
    },
    {
      
      icon: <i class="fa fa-camera-retro fa-2x text-primary"></i>,
      name: "Photography",
      discription: "Capture your best memories",
    },
  
    {
      icon: <i class="fa fa-wand-magic-sparkles fa-2x text-primary"></i>,
      name: "Decor",
      discription: "Get the best setups",
    },
  ...
  export const footerContact = [
    {
      ...
      name: "123 Street, Karachi, Pakistan",
    },
    {
